...
function HelpModal({ isApprover, onClose }) {
  const sections = isApprover ? [
    ...
    { icon:"🔔", title:"Waitlist", body:"When a slot is already booked, staff can click the 🔔 bell icon on that slot to join the waitlist." },
    ...
    { icon:"🔔", title:"Waitlist", body:"If a slot you want is already taken, click the 🔔 bell icon on it to join the waitlist for it." },
