...
function HelpModal({ isApprover, onClose }) {
  const sections = isApprover ? [
    ...
    { icon:"🕐", title:"Checking in", body:"Staff can check in from 15 minutes before their booking starts, from the booking card or the calendar views. This just marks the room as in use — it's informational, nothing happens automatically if no one checks in." },
    { icon:"🔔", title:"Waitlist", body:"When a slot is already booked, staff can click the 🔔 bell icon on that slot to join the waitlist. If the booking is cancelled, they get an email straight away so they can request it." },
    ...
    { icon:"🏥", title:"Clinical spaces", body:"Clinical rooms (marked \"APPROVER BOOKING ONLY\") can still be viewed — floor plans and the schedule views show what's booked, same as any other room — but can only be requested by an approver. If you need one, please speak to admin." },
    { icon:"🔁", title:"Recurring bookings", body:"When requesting a room, tick 'Recurring booking' to set up a repeating series — weekly, fortnightly, a custom number of weeks (e.g. every 3 weeks), monthly, or a specific day of the month (like every last Monday). The series is open-ended by default. Recurring bookings show a 🔁 badge everywhere they appear. If any date in the series clashes with an existing booking, you'll be offered the choice to skip that date or move just that occurrence to a similar free room, instead of the whole series being blocked." },
    ...
    { icon:"✅", title:"Checking in", body:"You can check in from 15 minutes before your booking starts, from your booking card. It's just a record that you're using the room." },
    { icon:"🔔", title:"Waitlist", body:"If a slot you want is already taken, click the 🔔 bell icon on it. You'll get an email if it becomes free because the booking was cancelled. It's first come, first served." },
